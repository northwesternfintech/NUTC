...
TEST_F(BasicMatching, CorrectBuyPricingOrder)
{
    ...
    MarketOrder buy2{"ABC", BUY, "MARKET", "ETHUSD", 1, 2};
    MarketOrder buy3{"ABC", BUY, "MARKET", "ETHUSD", 1, 3};
    MarketOrder buy4{"ABC", BUY, "MARKET", "ETHUSD", 1, 4};
    MarketOrder sell1{"DEF", SELL, "MARKET", "ETHUSD", 1, 1};
