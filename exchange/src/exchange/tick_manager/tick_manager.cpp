...
TickManager::tick_metrics_t
TickManager::get_tick_metrics() const
{
    ...
    if (num_ticks < 100) {
        return {milliseconds(0), milliseconds(0), milliseconds(0),
    ...
    return {
        100 * top_1p_ms / num_ticks,
        20 * top_5p_ms / num_ticks,
