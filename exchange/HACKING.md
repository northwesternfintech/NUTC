...
hidden if the `NUTC24_DEVELOPER_MODE` option is disabled. Enabling this
...
You have a few options to pass `NUTC24_DEVELOPER_MODE` to the configure
...
Runs the executable target `NUTC24_exe`.
