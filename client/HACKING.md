...
hidden if the `NUTC-client_DEVELOPER_MODE` option is disabled. Enabling this
...
You have a few options to pass `NUTC-client_DEVELOPER_MODE` to the configure
...
Runs the executable target `NUTC-client_exe`.
