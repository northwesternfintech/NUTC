const faqs = [
  ...
  },
  {
    ...
    answer:
      "Yes, we require teams of 2-4 during application."
  },
  {
    id: 5,
  ...
  return (
    <div className="bg-gray-900" id="faq">
      <div className="mx-auto max-w-7xl px-6 py-32 sm:py-48 lg:px-8">
        <h2 className="text-2xl font-bold leading-10 tracking-tight text-white text-center">Frequently asked questions</h2>
